...
export const typeTop = [
  ...
  // { title: "New", icon: <HomeIcon sx={{ fontSize: 35 }} /> },
  { title: "Shorts", icon: <AppShortcutOutlinedIcon sx={{ fontSize: 35 }} /> },
  // {
  //   title: "Subscription",
  //   icon: <SubscriptionsOutlinedIcon sx={{ fontSize: 35 }} />,
  // },
  // {
  //   title: "Library",
...
export const typeBottom = [
  ...
  { title: "Movies", icon: <LocalMoviesIcon sx={{ fontSize: 35 }} /> },
  { title: "Food", icon: <RamenDiningIcon sx={{ fontSize: 35 }} /> },
  { title: "News", icon: <NewspaperIcon sx={{ fontSize: 35 }} /> },
